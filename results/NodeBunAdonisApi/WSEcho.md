# JS Bun AdonisJS — WS Echo Benchmark

**Tested**: 2026-05-30 23:48:27 UTC
**Command**: `k6 run --vus 120 --duration 20s ws://127.0.0.1:8090/ws/echo`
...
default ↓ [ 100% ] 120 VUs  20s
  ...
  █ TOTAL RESULTS 
    ...
    checks_total.......: 45      0.899975/s
    checks_succeeded...: 0.00%   0 out of 45
    checks_failed......: 100.00% 45 out of 45
    ...
    ws_sessions...........: 49    0.979972/s




running (50.0s), 000/120 VUs, 29 complete and 91 interrupted iterations
default ✓ [ 100% ] 120 VUs  20s
```
