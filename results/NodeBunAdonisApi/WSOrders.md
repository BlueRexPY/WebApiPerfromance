# JS Bun AdonisJS — WS Orders Benchmark

**Tested**: 2026-05-30 23:47:28 UTC
**Command**: `k6 run --vus 120 --duration 20s ws://127.0.0.1:8090/ws/orders`
...
default ↓ [ 100% ] 120 VUs  20s
  ...
  █ TOTAL RESULTS 
    ...
    ws_sessions...........: 74    1.47996/s




running (50.0s), 000/120 VUs, 46 complete and 74 interrupted iterations
default ✓ [ 100% ] 120 VUs  20s
```
