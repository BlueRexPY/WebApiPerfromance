# JS Bun Nitro Cluster — WS Orders Benchmark

**Tested**: 2026-05-31 16:09:29 UTC
**Command**: `k6 run --vus 120 --duration 20s ws://127.0.0.1:8095/ws/orders`
...
default ↓ [ 100% ] 120 VUs  20s
  ...
  █ TOTAL RESULTS 
    ...
    checks_total.......: 26      0.519979/s
    checks_succeeded...: 0.00%   0 out of 26
    checks_failed......: 100.00% 26 out of 26

    ✗ ws connected (101)
      ↳  0% — ✓ 0 / ✗ 26

    EXECUTION
    iteration_duration....: avg=50s min=49.99s med=50s max=50s p(90)=50s p(95)=50s
    iterations............: 26    0.519979/s
    vus...................: 120   min=120    max=120
    vus_max...............: 120   min=120    max=120

    NETWORK
    data_received.........: 0 B   0 B/s
    data_sent.............: 23 kB 461 B/s

    WEBSOCKET
    ws_connecting.........: avg=50s min=49.99s med=50s max=50s p(90)=50s p(95)=50s
    ws_orders_rtt_ms......: avg=0   min=0      med=0   max=0   p(90)=0   p(95)=0  
    ws_session_duration...: avg=50s min=49.99s med=50s max=50s p(90)=50s p(95)=50s
    ws_sessions...........: 29    0.579977/s




running (50.0s), 000/120 VUs, 12 complete and 108 interrupted iterations
default ✓ [ 100% ] 120 VUs  20s
```
