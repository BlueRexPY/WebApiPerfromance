# JS Bun AdonisJS Cluster — WS Orders Benchmark

**Tested**: 2026-05-30 23:51:10 UTC
**Command**: `k6 run --vus 120 --duration 20s ws://127.0.0.1:8092/ws/orders`
...
default ↓ [ 100% ] 120 VUs  20s
  ...
  █ TOTAL RESULTS 
    ...
    checks_total.......: 48      0.959979/s
    checks_succeeded...: 0.00%   0 out of 48
    checks_failed......: 100.00% 48 out of 48

    ✗ ws connected (101)
      ↳  0% — ✓ 0 / ✗ 48

    EXECUTION
    iteration_duration....: avg=49.99s min=49.99s med=50s    max=50s p(90)=50s p(95)=50s
    iterations............: 48    0.959979/s
    ...
    ws_sessions...........: 55    1.099975/s




running (50.0s), 000/120 VUs, 26 complete and 94 interrupted iterations
default ✓ [ 100% ] 120 VUs  20s
```
