...
SERVICES: dict[str, Service] = {
    ...
    for s in [
        ...
        Service("rustaxum", 8022, "Rust Axum", "RustAxum", grpc_port=9022),
        Service("gochi", 8023, "Go Chi", "GoChi", grpc_port=9023),
        ...
        Service("gonethttp", 8032, "Go net/http", "GoNetHttp", grpc_port=9032),
        ...
        Service("gogin", 8066, "Go Gin", "GoGin", grpc_port=9066),
        ...
        Service("goechoapi", 8096, "Go Echo", "GoEcho", grpc_port=9096),
