...
SERVICES: dict[str, Service] = {
    ...
    for s in [
        ...
        Service("rustaxum", 8022, "Rust Axum", "RustAxum", grpc_port=9000),
        ...
        Service("gonethttp", 8032, "Go net/http", "GoNetHttp", grpc_port=9000),
        ...
        Service("gogin", 8066, "Go Gin", "GoGin", grpc_port=9000),
        ...
        Service("goechoapi", 8096, "Go Echo", "GoEcho", grpc_port=9000),
