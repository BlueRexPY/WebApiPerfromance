...
class ApiServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.GetOrders = channel.unary_unary(
                ...
                response_deserializer=api__pb2.GetOrdersReply.FromString,
                _registered_method=True)
...
def add_ApiServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetOrders': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=api__pb2.GetOrdersReply.SerializeToString,
            ),
    }
...
class ApiService:
    ...
    def GetOrders(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            api__pb2.GetOrdersReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
